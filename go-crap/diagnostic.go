...
// Diagnostic represents a single validation problem found in CRAP input.
...
// Directive represents a CRAP test point directive.
type Directive int
...
// EventType classifies a parsed CRAP line.
type EventType int
